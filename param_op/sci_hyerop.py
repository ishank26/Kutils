...
randgrid= RandomizedSearchCV(estimator=classif, param_distributions=dropout,n_iter=2)
print "Checking best hyper_params"
print X_train.shape, y_train.shape
opt_result=randgrid.fit(X_train,y_train)
print("Best:{0} using {1}".format(opt_result.best_score_, opt_result.best_params_))